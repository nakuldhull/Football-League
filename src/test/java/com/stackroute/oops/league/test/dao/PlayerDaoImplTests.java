...
class PlayerDaoImplTests {
    ...
    @Test
    @Order(1)
    public void givenPlayerDaoObjectThenPlayerListSetAsArrayList() throws IOException {
        assertThat(MESSAGE_ONE, playerDao.getAllPlayers(), is(empty()));
    }

    @Test
    @Order(2)
    public void givenPlayerDataWhenAddedThenReturnTrue() throws PlayerAlreadyExistsException, IOException {
        assertTrue(playerDao.addPlayer(player), MESSAGE_TWO);
    }

    @Test
    @Order(3)
    public void givenPlayerDataAddedThenReturnAllPlayers() throws IOException {
    ...
    @Test
    @Order(4)
    public void givenValidPlayerIdThenReturnPlayer() throws PlayerNotFoundException, IOException {
